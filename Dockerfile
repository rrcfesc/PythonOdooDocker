...
ADD extraFiles/xfonts-base_1.0.4+nmu1_all.deb xfonts-base_1.0.4+nmu1_all.deb
RUN dpkg -i xfonts-base_1.0.4+nmu1_all.deb && rm xfonts-base_1.0.4+nmu1_all.deb
ADD extraFiles/wkhtmltox_0.12.5-1.stretch_amd64.deb wkhtmltox_0.12.5-1.stretch_amd64.deb
